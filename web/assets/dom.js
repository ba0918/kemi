...
export const dom = {
  ...
  btnTitle: /** @type {HTMLButtonElement} */ (must("#btn-title")),
  btnMore: /** @type {HTMLButtonElement} */ (must("#btn-more")),
  viewMenu: must("#view-menu"),
  menuWrap: /** @type {HTMLButtonElement} */ (must("#menu-wrap")),
  ...
  menuThemeLabel: must("#menu-theme-label"),
  ...
  sheetMeta: must("#sheet-meta"),
  sheetNotes: must("#sheet-notes"),
