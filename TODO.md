...
## LAN 公開 `--bind`（branch `lan-bind`、未マージ）

- マージとリリース。実装 `c56e0e6`、テストの調整 `1880155`（土台は plan `4bc9253` / 仕様 `cea6c38`）。
  リリース時に `CHANGELOG.md` の `[Unreleased]` に書く
...
- 最新のリリースは v0.1.6。変更の記録は `CHANGELOG.md`
